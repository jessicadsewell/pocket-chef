...
const Login: React.FC<Props> = ({ error: initialError }) => {
  ...
  const { signIn, signInWithGoogle, signInWithMagicLink, resetPassword } =
    useAuth();
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          {magicLinkSent && (
            <div className="bg-green-50 border border-green-200 text-green-600 px-4 py-3 rounded-lg mb-4">
              ✉️ Magic link sent! Check your email and click the link to sign
              in.
            </div>
          )}
